...
seasons = [str(i) for i in range(1, 2)]
text = ''
index = 1
requests = 0
start_time = time()
...
for seasons in seasons:
    ...
    response = get(
        'https://www.imdb.com/title/tt0903747/episodes?season=' + seasons)
...
with open('data.csv') as csv_file:
    ...
    print(f'Processed {line_count} lines. CSV finished')
...
print('\nlength >5 result :', l2)
print('\nlength <9 result :', l3)
print('\smooth δ=1.2 result :', s1)
print('\smooth δ=1.4 result :', s2)
print('\smooth δ=1.6 result :', s3)
print('\smooth δ=1.8 result :', s4)
print('\smooth δ=2.0 result :', s5)
print('\word frequency >2 result  :', w1)
print('\word frequency >11 result :', w2)
print('\word frequency >21 result :', w3)
print('\word frequency remove top 5% result :', w4)
print('\word frequency remove top 10% result :', w5)
print('\word frequency remove top 20% result :', w6)
...
# plot 2:
x = np.array(['original', 'min2', 'min10', 'min20', 'top5', 'top10', 'top20'])
