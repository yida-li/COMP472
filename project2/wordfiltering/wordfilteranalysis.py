...
with open('wordfiltering/ResultsmodelMin2.txt', 'w') as f:
...
with open('wordfiltering/ResultsmodelMin10.txt', 'w') as f:
...
with open('wordfiltering/ResultsmodelMin20.txt', 'w') as f:
...
with open('wordfiltering/ResultsmodelPercent5.txt', 'w') as f:
...
with open('wordfiltering/ResultsmodelPercent10.txt', 'w') as f:
...
with open('wordfiltering/ResultsmodelPercent20.txt', 'w') as f:
